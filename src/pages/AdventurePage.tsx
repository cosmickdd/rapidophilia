...
const AdventurePage: React.FC = () => {
  ...
  const filteredAdventures = useMemo(() => {
    let filtered = featuredAdventures.filter(adventure => {
      ...
      const matchesCategory = !categoryFilter || adventure.category === categoryFilter;
      const matchesDuration = !durationFilter || adventure.duration.includes(durationFilter);
    ...
    return filtered;
  }, [searchTerm, categoryFilter, durationFilter, sortBy]);

  const categories = ['Cultural Trek', 'Wildlife Safari', 'Cultural Experience', 'Paragliding', 'River Rafting', 'Rock Climbing'];
  const durations = ['7', '8', '10', '14'];
  ...
  return (
    <Layout>
      <div className="min-h-screen">
        {/* Hero Section */}
        <Hero
          title="Experience The Authenticity Of Travel"
          subtitle="ADVENTURE"
          description="Embark on extraordinary adventures that showcase authentic cultural experiences and natural wonders around the world"
                    ...
                    <div className="relative h-64 overflow-hidden bg-gray-200">
                      <img
                        ...
                        onError={(e) => {
                          ...
                          target.src = 'https://images.unsplash.com/photo-1501594907352-04cda38ebc29?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80';
                        }}
                        loading="lazy"
                      />
            ...
            {filteredAdventures.length === 0 && (
              ...
              >
                <div className="text-gray-400 mb-4">
                  {FiGlobe({ className: "h-16 w-16 mx-auto" })}
                </div>
            ...
            >
              ...
              >
                <div className="w-24 h-24 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center mx-auto">
                  {FiGlobe({ className: "h-12 w-12 text-white" })}
                </div>
              </motion.div>
              ...
              >
                Let us create a customized adventure experience just for you. Contact our experts for personalized recommendations and authentic travel experiences.
              </motion.p>
